          ...
          <div className="relative rounded-3xl overflow-hidden p-12 lg:p-20 text-center bg-gradient-to-br from-[#1A2B3A] to-[#0F1D2A] border border-white/10">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg md:text-xl text-white/60 mb-12 max-w-3xl mx-auto leading-relaxed">
                دعنا نبني لك مشروعًا يستحق أن يُضاف إلى هذه القائمة.
              </p>
              <Link to="/contact" className="inline-block px-8 py-5 bg-[#5DDCD1] text-[#0F1D2A] rounded-xl hover:bg-[#4DCCC1] transition-all duration-300 shadow-2xl shadow-[#5DDCD1]/30 hover:shadow-[#5DDCD1]/50 hover:scale-105 text-lg">
                احجز استشارة مجانية
              </Link>
            </div>
          </div>
